function __Demo__Remane-Aecapsetihwsnasll {
    Param(
...
function __Demo__Nwe-Nmetieto {
    ...
    $fullFileNamePattern =
_       "(?<prefix>\w+)_-_\d{4}(-\d{2}){2}_(?<description>.+)(?<extension>\.\w(\w|\d)*)" # Uses DateTimeFormat
